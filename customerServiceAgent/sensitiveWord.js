 ...
 * 说明：
 * - 该文件用于定义需要过滤的敏感词列表
 * - 敏感词数组中的词汇将被用于检测和过滤用户输入及API返回内容
 * - 请根据实际业务需求添加或删除敏感词
 *
 * 使用方式：
 * - 直接在数组中添加需要过滤的敏感词字符串
...
/* ===================== 敏感词数组 ===================== */
var SENSITIVE_WORDS = [];
// 注意：SENSITIVE_WORDS.push() 必须在所有敏感词数组定义之后执行，已在文件末尾调用
...
const sWord = [
  ...
  "操逼电影",
  "英雄世纪",
  "东突，免费淫色情电影令人喷血的春宫108姿势(组图)18岁禁看",
  "跑跑卡丁车",
  "9之游",
  "淫b",
  "裸",
  ...
  "消息公告",
  "民進黨",
  "streetof EROS 07 小泉リカ",
  "webmaster",
  "俄罗斯",
  "水去车仑",
  "毛天安门",
  "MugenVol。11 Ai Hazawa羽沢愛！【AVI/ 699MB】",
  "淫婦",
  "婊子",
  "肉棒猛烈拔插",
  "荡母淫儿",
...
// 在所有敏感词数组定义之后，合并到 SENSITIVE_WORDS
SENSITIVE_WORDS.push(...politicalWord, ...eroticWord, ...sWord, ...newWord, ...newData2);
